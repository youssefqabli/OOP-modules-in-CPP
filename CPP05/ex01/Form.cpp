...
Form::Form() : name(""), gradeSigned(0), gradeExecute(0) {};
...
Form::Form(const Form &other) : name(other.getName()), gradeSigned(other.getGradeSigned()), gradeExecute(other.getGradeExecute()) {
    *this = other;
}
